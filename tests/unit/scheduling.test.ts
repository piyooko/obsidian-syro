...
test("Test textInterval - desktop", () => {
    expect(textInterval(0.01, false)).toEqual("14.4m");
    expect(textInterval(0.5, false)).toEqual("12h");
    expect(textInterval(1, false)).toEqual("1d");
    expect(textInterval(41, false)).toEqual("1.3m");
    expect(textInterval(366, false)).toEqual("1y");
    expect(textInterval(1000, false)).toEqual("2.7y");
});

test("Test textInterval - mobile", () => {
    expect(textInterval(0.01, true)).toEqual("14.4m");
