...
> _Note: Some screenshots in this documentation may come from earlier versions of the interface, but the core layout and entry logic remain largely the same and can still serve as a useful visual reference._
