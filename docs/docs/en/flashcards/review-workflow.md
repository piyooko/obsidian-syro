...
_Tip: You can collapse parent decks that do not need your attention, or trigger review from a single note when you want to focus intensely on a specific area._
