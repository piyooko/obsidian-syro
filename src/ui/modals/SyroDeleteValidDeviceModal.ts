...
export class SyroDeleteValidDeviceModal extends Modal {
    ...
    onOpen(): void {
        ...
        contentEl.createEl("h2", {
            text: t("SYRO_DELETE_VALID_DEVICE_TITLE"),
        });
        contentEl.createEl("p", {
            text: t("SYRO_DELETE_VALID_DEVICE_CONFIRM", {
                device: this.deviceName,
            }),
        });

        new Setting(contentEl)
            .setName(t("SYRO_DELETE_VALID_DEVICE_CONFIRM_LABEL"))
            .setDesc(
                t("SYRO_DELETE_VALID_DEVICE_CONFIRM_DESC", {
        ...
        this.confirmButton = new ButtonComponent(buttonRow)
            .setButtonText(t("SYRO_DELETE_VALID_DEVICE_BUTTON"))
            .setWarning()
            .onClick(() => {
                if (!this.isConfirmed()) {
                    return;
    ...
    private getRequiredPhrase(): string {
        return t("SYRO_DELETE_VALID_DEVICE_PHRASE");
    }
