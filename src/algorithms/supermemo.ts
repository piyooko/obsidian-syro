/**
 * 杩欎釜鏂囦欢涓昏鏄共浠€涔堢殑锛?
 * [绠楁硶灞俔 SM-2 (SuperMemo 2) 绠楁硶鐨勪弗鏍煎疄鐜般€?
 * 鎻愪緵浜嗘渶缁忓吀鐨?SM-2 璋冨害閫昏緫锛屼富瑕佷綔涓轰竴绉嶆浛浠ｉ€夋嫨銆?
 *
 ...
 */
/**
 * [绠楁硶灞傦細璐熻矗璁＄畻涓嬩竴娆″涔犵殑鏃堕棿銆侀棿闅斿拰闅惧害] [鏍稿績] SM-2 绠楁硶瀹炵幇銆?
 */
...
export class Sm2Algorithm extends SrsAlgorithm {
    ...
    displaySettings(
        ...
        setSanitizedHtml(containerEl.createDiv(), t("SM2_ALGORITHM_DESC"), {
            allowedTags: ["a"],
            allowedAttributes: {
                a: ["href"],
            },
