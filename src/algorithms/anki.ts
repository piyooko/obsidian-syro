/**
 * 杩欎釜鏂囦欢涓昏鏄共浠€涔堢殑锛?
 * [绠楁硶灞俔 Anki 榛樿绠楁硶鐨勫叿浣撳疄鐜般€?
 * 瀹炵幇浜嗗熀浜?Ease Factor 鐨勭粡鍏?Anki 绠楁硶閫昏緫銆傚綋鐢ㄦ埛璇勫垎 Again/Hard/Good/Easy 鏃讹紝璁＄畻涓嬩竴娆＄殑闂撮殧鍜?Ease 鍙樺寲銆?
 *
 ...
 */
/**
 * [绠楁硶灞傦細璐熻矗璁＄畻涓嬩竴娆″涔犵殑鏃堕棿銆侀棿闅斿拰闅惧害] [鏍稿績] Anki 榛樿绠楁硶瀹炵幇銆?
 */
...
import { setSanitizedHtml } from "src/util/safeHtml";
...
export class AnkiAlgorithm extends SrsAlgorithm {
    ...
    importer(fromAlgo: algorithmNames, items: RepetitionItem[]): void {
        switch (fromAlgo) {
            ...
            case algorithmNames.SM2:
                console.debug("use same data, don't have to convert.");
                break;
    ...
    displaySettings(
        ...
        setSanitizedHtml(containerEl.createDiv(), t("ANKI_ALGORITHM_DESC"), {
            allowedTags: ["a"],
            allowedAttributes: {
                a: ["href"],
            },
