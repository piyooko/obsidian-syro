 ...
 * 这个文件主要是干什么的�?
 * [算法层] Anki 默认算法的具体实现�?
 * 实现了基�?Ease Factor 的经�?Anki 算法逻辑。当用户评分 Again/Hard/Good/Easy 时，计算下一次的间隔�?Ease 变化�?
 *
 * 它在项目中属于：算法�?(Algorithms) / 实现 (Implementation)
 *
 * 它会用到哪些文件�?
 ...
 */
/**
 * [算法层：负责计算下一次复习的时间、间隔和难度] [核心] Anki 默认算法实现�?
 */
