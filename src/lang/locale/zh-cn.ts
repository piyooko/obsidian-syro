...
export default {
    ...
    "FOLDER_TRACKING_TAGS": "托管标签",
    "FOLDER_TRACKING_TAGS_DESC":
        "支持任意标签，使用空格、逗号或换行分隔。关闭时只会移除这条规则自己添加过的标签。",
    "FOLDER_TRACKING_TAGS_PLACEHOLDER": "#review\nproject/alpha",
    "FOLDER_TRACKING_FOOTER_NOTE": "子文件夹可以覆盖这里的设置。点击保存后会立即批量应用到当前文件夹。",
    "FOLDER_TRACKING_SAVE_SUCCESS": "文件夹追踪设置已保存",
    "FOLDER_TRACKING_RESET": "恢复继承",
    "FOLDER_TRACKING_RESET_SUCCESS": "已清除当前文件夹的独立设置",
