...
export default {
    ...
    INLINE_TITLE_CARD_PROGRESS_TOOLTIP: "当前笔记可复习卡片：${reviewableCount} / ${totalCount}",
    INLINE_TITLE_CARD_NO_CARDS: "当前笔记中没有闪卡",
    INLINE_TITLE_CARD_MENU_TOOLTIP: "更多笔记复习选项",
    ...
    EXTRACT_MEMO_PLACEHOLDER: "记录这段摘录为什么重要",
    EXTRACT_BODY_LABEL: "摘录正文",
    EXTRACT_EDIT_BODY: "编辑",
    EXTRACT_FINISH_EDIT: "完成",
    EXTRACT_CONTINUE_EXTRACT: "继续摘录选区",
    EXTRACT_OPEN_SOURCE: "打开来源",
    EXTRACT_GRADUATE: "毕业",
    EXTRACT_PRIORITY_LABEL: "优先级",
    EXTRACT_SAVED: "已保存",
    EXTRACT_SAVING: "正在保存...",
    ...
    EXTRACT_REVIEW_GOOD: "良好",
    EXTRACT_REVIEW_SET_DATE: "指定",
    EXTRACT_REVIEW_SET_DATE_INTERVAL_HINT: "${interval}天",
    EXTRACT_REVIEW_GRADUATE: "毕业",
    EXTRACT_MOVE_TO_END: "将该摘录移动到学习队列末尾",
    EXTRACT_MOVED_TO_END: "已将该摘录移动到学习队列末尾",
    EXTRACT_RENDER_DEBUG_TITLE: "摘录渲染仍在等待",
    EXTRACT_RENDER_DEBUG_STEP: "步骤：${stage}",
    EXTRACT_RENDER_DEBUG_DETAIL: "详情：${detail}",
    EXTRACT_RENDER_DEBUG_ERROR: "错误：${error}",
    EXTRACT_RENDER_DEBUG_CONSOLE: "打开开发者控制台并搜索 SR-ExtractRender。",
    EXTRACT_SET_DATE_TITLE: "设置几天后到期",
    EXTRACT_SET_DATE_LABEL: "多少天后到期",
    EXTRACT_SET_DATE_INVALID: "请输入大于 0 的天数",
    EXTRACT_SOURCE_AUTO_HEADING: "自动·标题",
    EXTRACT_SOURCE_AUTO_PARAGRAPH: "自动·段落",
    EXTRACT_SOURCE_MANUAL: "手动摘录",
    EXTRACT_STATS_LABEL: "${count} 条摘录",
    EXTRACT_TIMELINE_ACTIVE_TITLE: "活跃摘录",
    ...
    CMD_CREATE_EXTRACT_FROM_SELECTION: "从选中文本创建摘录",
    CMD_TOGGLE_REVIEW_EDIT_MODE: "切换复习编辑模式",
    ...
    AUTO_EXTRACT_MENU_TITLE: "智能切片全文",
    AUTO_EXTRACT_ALL_HEADINGS: "智能切分全文",
    AUTO_EXTRACT_BY_HEADING_LEVEL: "按 H${level} 标题切片",
    AUTO_EXTRACT_BY_PARAGRAPH: "按段落切片",
    AUTO_EXTRACT_DISABLE: "关闭智能切片",
    AUTO_EXTRACT_RULE_ENABLED: "已启用智能切片",
    AUTO_EXTRACT_RULE_DISABLED: "已关闭智能切片",
    ...
    TIMELINE_CLEAR_EXTRACT_MEMO: "清空摘录备注",
    TIMELINE_REMOVE_EXTRACT_MARK: "移除摘录标记和备注",
    TIMELINE_PREFERENCES: "时间线偏好",
    TIMELINE_PREFERENCE_SHOW_EXTRACTS: "摘录",
    TIMELINE_PREFERENCE_SHOW_AUTO_EXTRACTS: "自动摘录",
    TIMELINE_PREFERENCE_SHOW_GRADUATED_EXTRACTS: "毕业摘录",
    TIMELINE_PREFERENCE_SHOW_COMMIT_MESSAGES: "提交信息",
    ...
    SYRO_SELECT_CURRENT_DEVICE_LAST_SEEN: "最后活跃",
    SYRO_DELETE_INVALID_DEVICE_TITLE: "删除异常设备目录",
    ...
    NOTICE_SYRO_DEVICE_RENAMED: "当前 Syro 设备名称已更新。",
    NOTICE_SYRO_DEVICE_PULLED: "已用所选设备的快照覆盖当前设备数据。",
    ...
    SETTINGS_SYNC_DEVICE_FOLDER: "设备目录",
    SETTINGS_SYNC_DEVICE_SIZE: "占用",
    SETTINGS_SYNC_DEVICE_LAST_SEEN: "最后活跃",
    SETTINGS_SYNC_DEVICE_REVIEW_COUNT: "设备复习次数",
    SETTINGS_SYNC_DEVICE_LATEST_SESSION: "最近会话",
    SETTINGS_SYNC_DEVICE_LAST_PULL: "上次拉取",
    SETTINGS_SYNC_DEVICE_INACTIVE_DAYS: "闲置时长",
    SETTINGS_SYNC_DEVICE_INACTIVE_DAYS_VALUE: "闲置 ${days} 天",
    SETTINGS_SYNC_DEVICE_STATUS_NEEDS_SYNC: "可同步更新",
    SETTINGS_SYNC_DEVICE_STATUS_IDLE: "闲置",
    SETTINGS_SYNC_DEVICE_STATUS_NO_SESSION: "无会话",
    ...
    SETTINGS_SYNC_INVALID_DEVICE_FILES: "目录内容",
    SETTINGS_SYNC_INVALID_DEVICE_EMPTY: "当前没有异常设备目录。",
    SETTINGS_SYNC_VALID_DEVICE_EMPTY: "当前没有其他有效设备。",
    SETTINGS_SYNC_DELETE_INVALID_DEVICE: "删除异常目录",
    SETTINGS_SYNC_INVALID_REASON_MISSING_DEVICE_JSON: "缺少 device.json",
    SETTINGS_SYNC_INVALID_REASON_INVALID_DEVICE_JSON: "device.json 结构不合法",
    SETTINGS_SYNC_INVALID_REASON_UNREADABLE_DEVICE_JSON: "device.json 无法可靠读取",
    ...
    SETTINGS_MAX_EXTRACT_REVIEWS_DESC: "每天最多显示多少条到期摘录复习。",
    ...
    DECK_OPTIONS_SECTION_DAILY_LIMITS: "每日上限",
    DECK_OPTIONS_SECTION_LEARNING_INTERVALS: "学习与遗忘间隔",
    DECK_OPTIONS_SECTION_DISPLAY_ORDER: "展示顺序",
    DECK_OPTIONS_LEARNING_STEPS: "初学间隔",
    DECK_OPTIONS_LEARNING_STEPS_DESC: "间隔之间用空格分隔（如 1m 10m）。支持 m(分) h(时) d(天)",
    DECK_OPTIONS_MAX_NEW_CARDS: "每日新卡片上限",
    ...
    DECK_OPTIONS_REVIEW_QUEUE_MODE: "闪卡 / 摘录出队策略",
    DECK_OPTIONS_REVIEW_QUEUE_MODE_DESC: "控制复习时闪卡队列和摘录队列的相对顺序",
    DECK_OPTIONS_REVIEW_QUEUE_MODE_EXTRACT_FIRST: "摘录优先",
    DECK_OPTIONS_REVIEW_QUEUE_MODE_FLASHCARD_FIRST: "闪卡优先",
    DECK_OPTIONS_REVIEW_QUEUE_MODE_INTERLEAVED: "交叉复习",
    DECK_OPTIONS_INTERLEAVE_FLASHCARD_COUNT: "每几张闪卡后复习 1 条摘录",
    DECK_OPTIONS_INTERLEAVE_FLASHCARD_COUNT_DESC:
        "仅在交叉复习中生效。默认每 4 张闪卡后显示 1 条摘录",
    DECK_OPTIONS_MAX_REVIEWS: "每日卡片复习上限",
    ...
    UI_EDIT_TOGGLE_KEY_UNSET: "暂未设置快捷键",
    UI_EXIT_KEY_HINT: "Alt+E 退出",
