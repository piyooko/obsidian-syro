...
export default normalizeSentenceCaseLocale({
    ...
    EXTRACT_RENDER_DEBUG_ERROR: "Error: ${error}",
    EXTRACT_RENDER_DEBUG_CONSOLE: "Open the developer console and search for SR-ExtractRender.",
    EXTRACT_SET_DATE_TITLE: "Set extract review due in",
    EXTRACT_SET_DATE_LABEL: "Days from now",
    EXTRACT_SET_DATE_INVALID: "Enter a positive number of days",
    ...
    AUTO_EXTRACT_ALL_HEADINGS: "Smart slice all headings",
    ...
    TIMELINE_CLEAR_EXTRACT_MEMO: "Clear extract memo",
    TIMELINE_REMOVE_EXTRACT_MARK: "Remove extract mark and memo",
    TIMELINE_PREFERENCES: "Timeline preferences",
    TIMELINE_PREFERENCE_SHOW_EXTRACTS: "Extracts",
    TIMELINE_PREFERENCE_SHOW_AUTO_EXTRACTS: "Auto extracts",
    TIMELINE_PREFERENCE_SHOW_GRADUATED_EXTRACTS: "Graduated extracts",
    TIMELINE_PREFERENCE_SHOW_COMMIT_MESSAGES: "Commit messages",
