...
class SingleDeckIterator {
    ...
    setCardListType(cardListType?: CardListType, cardIdx: number = null): void {
...
//
// Handling of multi-deck cards for legacy compatibility.
...
export class DeckTreeIterator implements IDeckTreeIterator {
    ...
    setCurrentCard(card: Card, deck: Deck): void {
        ...
        if (cardIdx >= 0) {
            this.singleDeckIterator.setCardListType(cardListType, cardIdx);
        }
    }
}
